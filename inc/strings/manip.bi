...
# ifndef FB_STRINGS_MANIP_BI__
# define FB_STRINGS_MANIP_BI__ -1
...
namespace detail
    ...
    ' The default buffer size used in strings.Replace.
    ...
    ''  (begin code)
    ''      strings.Replace(subject, oldtext(i), newtext)
    ''  (end code)
    ''  is called.
    ...
    ''  (begin code)
    ''      strings.Replace(subject(i), oldtext, newtext)
    ''  (end code)
    ''  is called.
    ...
    ''  (begin code)
    ''      var tmp = subject
    ''      strings.Replace(tmp, oldtext, newtext)
    ''      return tmp
    ''  (end code)
    ...
    ''          result(i) = strings.Replace(subject(i), oldtext, newtext)
    ''      next i
    ''  (end code)
    ...
    ''  (begin code)
    ''      result(n) = strings.Reverse(subject(n))
    ''  (end code)
    ''  is called.
    ...
    ''  (begin code)
    ''      result(m) = strings.Reverse(subject(n))
    ''  (end code)
