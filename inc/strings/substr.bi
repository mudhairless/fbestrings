...
# ifndef FB_STRINGS_SUBSTR_BI__
# define FB_STRINGS_SUBSTR_BI__ -1
...
namespace strings
	...
	''dim as ubyte what = 0
	''
	''var t = strings.tokenize(x, " ,.", @what)
	''
	''while t <> ""
	''	print using !"&  \"&\""; t; chr(what)
	''	t = strings.tokenize(, " ,.", @what)
	''wend
	''(end code)
	''
	declare function tokenize( byval x as zstring ptr = 0, byref tkns as const string, byval lastfound as ubyte ptr = 0, byval eattkns as boolean = true ) as string
